...
aideの設計資料は [設計思想/](設計思想/) にまとめている。

| ドキュメント | 内容 |
|---|---|
| [aide-principles.md](設計思想/aide-principles.md) | 共通原則・コマンドフロー・早見表 |
| [design-philosophy.md](設計思想/design-philosophy.md) | 設計思想（AI-DLC・SDD/DDD/TDD・ハイブリッドプロセス） |
| [aide-workflows.md](設計思想/aide-workflows.md) | PM業務・新規開発・運用保守のワークフロー詳細 |
| [aide-command-reference.md](設計思想/aide-command-reference.md) | コマンドリファレンス・ツール別対応表 |
| [aide-document-management.md](設計思想/aide-document-management.md) | フォルダ構成・命名規則・ブレスト管理 |
| [aide-subagent-architecture.md](設計思想/aide-subagent-architecture.md) | サブエージェント並列活用アーキテクチャ |
| [aide-anti-patterns.md](設計思想/aide-anti-patterns.md) | やってはいけないこと・推奨拡張 |
